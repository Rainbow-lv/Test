...
/** 
 * DAO for table "SHOP_CAR_BEAN".
*/
public class ShopCarBeanDao extends AbstractDao<ShopCarBean, Long> {

    public static final String TABLENAME = "SHOP_CAR_BEAN";

    /**
     * Properties of entity ShopCarBean.<br/>
    ...
    public ShopCarBeanDao(DaoConfig config) {
        super(config);
    }
    
    public ShopCarBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SHOP_CAR_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SHOP_CAR_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ShopCarBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ShopCarBean entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getId());
        stmt.bindLong(2, entity.getCommodityId());
    ...
    @Override
    public ShopCarBean readEntity(Cursor cursor, int offset) {
        ShopCarBean entity = new ShopCarBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, ShopCarBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(ShopCarBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(ShopCarBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(ShopCarBean entity) {
